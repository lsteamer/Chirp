package com.anjegonz.core.presentation.util
...
fun currentDeviceConfiguration(): DeviceConfiguration{
    ...
    return DeviceConfiguration.fromWindowsSizeClass(windowsSizeClass)
}
...
enum class DeviceConfiguration {
    ...
    companion object{
        fun fromWindowsSizeClass(windowsSizeClass: WindowSizeClass) : DeviceConfiguration {

            return with(windowsSizeClass){
                when {
